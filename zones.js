...
const ALLURE_PLUS_ZONES = {
  ...
  EF:         { pctLow: 0.62, pctHigh: 0.70 },
  TEMPO:      { pctLow: 0.71, pctHigh: 0.75 },
  AS42:       { pctLow: 0.76, pctHigh: 0.79 },
  SWEET_SPOT: { pctLow: 0.80, pctHigh: 0.83, isSweetSpot: true },
  AS21:       { pctLow: 0.82, pctHigh: 0.85 },
  S60:        { pctLow: 0.84, pctHigh: 0.87 },
  AS10:       { pctLow: 0.88, pctHigh: 0.91 },
  S30:        { pctLow: 0.92, pctHigh: 0.94 },
...
// zoneKind doit l'emporter ici : cote donnees reelles Campus, un retour au
// calme etiquete EF au lieu de Recuperation induit en erreur (verifie sur
// plusieurs seances reelles - "Bloc Choc", "Seuil 60", etc. terminent
// toujours par un exercice CD_N slug=endurance-fondamentale/kind=RECOVER).
